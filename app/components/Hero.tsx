    ...
    return (
        ...
        padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row '>
            ...
            <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
                <Image src='/camp.svg' alt='camp' width={50}
                       height={50} className='absolute left-[-5px]  top-[-30px] w-10 lg:w-[50px]'/>
                ...
                <div className='my-11 flex flex-wrap gap-5'>
                    ...
                    <p className='bold-16 lg:bold-20 text-blue-70'>
                        198K
                        <span className='regular-16 lg:regular-20 underline ml-1'>Excellent Reviews</span>
                    </p>
                </div>
